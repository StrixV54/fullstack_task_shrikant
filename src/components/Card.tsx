...
const CardContainer: React.FC<LayoutProps> = ({ children }) => {
    return <div className="sm:w-[509px] w-full min-w-[320px] h-[496px] overflow-hidden bg-white rounded-xl shadow-large border border-gray-300">{children}</div>;
};
...
const CardHeader: React.FC = () => {
    return (
        <div className="flex items-center px-6 py-4">
            ...
            <h1 className="text-3xl font-bold ml-0 translate-y-[2px]">Note App</h1>
        </div>
    );
};
